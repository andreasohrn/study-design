...
Choose an area of interest (e.g. protein supplementation for muscle hypertrophy or the effect of block periodization on VO<sub>2max</sub>). Find at least five *original research studies*[^04-study-design-oppgave-1] in your selected area and describe strength and weakness of these studies (see below). The report should focus on the design of the studies and selection of statistical tests to answer study aims. Conclude your report with a recommendation, how should future studies in your area be designed to best answer similar questions?

[^04-study-design-oppgave-1]: Avoid using review articles or meta-analyses
...
When **analyzing** your studies you can use the QALMRI method[^04-study-design-oppgave-2].

[^04-study-design-oppgave-2]: See [Teaching undergraduate students to read empirical articles: An evaluation and revision of the QALMRI method](https://psyarxiv.com/p39sc/), this advice was also heavily influenced by [this website](https://bartlettje.github.io/2021-10-06-learning-to-read-scientific-journal-articles/)
...
6.  Describe the study design. Use Hulley, (2013), Chapters 7-13[^04-study-design-oppgave-3] in your analysis.
...
[^04-study-design-oppgave-3]: Hulley, S. B. (2013). Designing clinical research. Philadelphia, Wolters Kluwer/Lippincott Williams & Wilkins.
